(function ($) {
    $(document).ready(function () {
        ...
        $.fn.wiFeedBack = function (options) {
            ...
            fb.find('button, .button').wrap('<div class="wi-fb-btn"></div>');

            // Messages
            if (/ru/i.test($('html').attr('lang'))) {
                fb.append('<div class="wi-fb-spinner"></div><div class="wi-fb-msg-invalid">Отмеченные поля заполнены некорректно</div><div class="wi-fb-msg-sent">Ваша заявка принята!</div><div class="wi-fb-msg-notsent">При отправке данных произошла ошибка</div>');
            } else {
                fb.append('<div class="wi-fb-spinner"></div><div class="wi-fb-msg-invalid">Marked fields are required</div><div class="wi-fb-msg-sent">Your request is sent!</div><div class="wi-fb-msg-notsent">An error occurred while sending data</div>');
            }
